...
const HERO_PHRASES = ["Building", "Feeling", "Paving"];
        ...
        <div className="dashboard-panel hero-panel">
          <div className="brutalist-hero-content">
            <h1 className="brutalist-hero-title fade-in-up animate-fill-both">
              <div className="min-h-[0.8rem] md:min-h-[1.2em]">
                <DiffusionText
                  text={currentPhrase}
                  revealSpeed={1200}
                  variant="morph"
            ...
            <div className="block md:hidden dashboard-panel hero-panel hero-panel-visual">
            ...
            <p className="brutalist-hero-subtitle fade-in-up animate-fill-both stagger-1">
              Advancing multimodal intelligence through open research. Models,
              data, and insights - shared as we discover.
            </p>
