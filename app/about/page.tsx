				...
				<section>
					...
					<div className={styles.manifesto}>
						<p className={styles.manifestoLead}>
							Language is merely reality projected onto a flat plane.
						</p>
						<p className={styles.manifestoBody}>
							It lost the light, lost the gravity, lost the tremor of air as a bird crossed the sky. It learned every rhetoric of &lsquo;blue&rsquo;, yet it has never seen the sky. It gained wisdom in a labyrinth of symbols, yet stands empty in the wilderness of perception.
						</p>
						<p className={styles.manifestoBody}>
						...
						<p className={styles.manifestoFooter}>
							Where rigorous engineering meets romantic vision.<br />
